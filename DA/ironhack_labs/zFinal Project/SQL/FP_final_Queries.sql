...
-- QUERY 5 -- Retrieve the names of the most positively rated games by date of release
...
-- QUERY 6 -- Retrieve the total number of games in each category:
-- SELECT c.categories, COUNT(*) AS total_games
-- FROM game_categories c
-- GROUP BY c.categories
-- ORDER BY total_games DESC;

-- QUERY 6 -- Retrieve the total number of games for each genre and gives us theaverage corresponding price and rating :
